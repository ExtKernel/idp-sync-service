...
import com.iliauni.usersyncglobalservice.idp.ipa.IpaIdpUsergroupRequestSender;
...
public class IpaIdpUsergroupRequestSenderTest {
    ...
    private IpaIdpUsergroupRequestSender ipaIdpUsergroupRequestSender;
    ...
    public void createUsergroup_WhenGivenClientAndUsergroup_ShouldReturnUsergroup()
        ...
        requestBody.put("params", new Object[]{"", usergroupMap});
    ...
    public void getUsergroup_WhenGivenClientAndUsergroupName_ShouldReturnUsergroup()
        ...
        requestBody.put("params", new Object[]{usergroup.getName(), new HashMap<>()});
