...
import com.iliauni.usersyncglobalservice.ipa.IpaUsergroupIdpRequestSenderResultBlackListFilter;
...
class IpaUsergroupIdpRequestSenderResultBlackListFilterTest {

    private IpaUsergroupIdpRequestSenderResultBlackListFilter filter;
    private IpaClient client;

    // Initialize the filter and client instances before each test
    @BeforeEach
    void setUp() {
        filter = new IpaUsergroupIdpRequestSenderResultBlackListFilter();
