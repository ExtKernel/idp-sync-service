...
import com.iliauni.usersyncglobalservice.kc.SyncKcUsergroupIdpRequestSenderResultBlackListFilter;
...
class SyncKcUsergroupIdpRequestSenderResultBlackListFilterTest {

    private SyncKcUsergroupIdpRequestSenderResultBlackListFilter filter;
    private SyncKcClient client;

    // Initialize the filter and client instances before each test
    @BeforeEach
    void setUp() {
        filter = new SyncKcUsergroupIdpRequestSenderResultBlackListFilter();
