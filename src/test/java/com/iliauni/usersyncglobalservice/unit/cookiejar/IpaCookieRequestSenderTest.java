...
public class IpaCookieRequestSenderTest {
    @Mock
    ...
    public void getCookie_WhenGivenClient_ShouldReturnString()
        ...
        assertEquals(response.getHeaders().getFirst(HttpHeaders.SET_COOKIE), ipaCookieJarRequestSender.getCookie(client, ipaApiUrl));
    }
}
