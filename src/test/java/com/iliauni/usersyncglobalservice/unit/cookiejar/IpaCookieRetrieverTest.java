...
public class IpaCookieRetrieverTest {
    @Mock
    ...
    public void retrieveCookieJar_WhenGivenClient_ShouldReturnCookie()
        ...
        when(ipaIdpUserRequestSender.getCookie(client, null)).thenReturn(cookie);

        assertEquals(cookie, ipaCookieJarRetriever.retrieveCookieJar(client, null));
    }
}
